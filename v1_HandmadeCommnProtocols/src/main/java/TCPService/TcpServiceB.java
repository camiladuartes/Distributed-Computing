...
public class TcpServiceB {
    ...
    public TcpServiceB(String port) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		System.out.println(">>> ServiceB: TDP Server Service Started");
        new TcpServiceB(args[0]).service();
        System.out.println("\n>>> ServiceB: TDP Server Terminating...");
    }
}